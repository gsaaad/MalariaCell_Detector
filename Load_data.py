...
def load_malaria_cell_images(data_dir, label_file, pdf_output=False, images_per_pdf=500):
    images = []
    image_ids = []
...
if __name__ == "__main__":
    ...
    data_dir = r'C:\Users\geosaad\Desktop\MalariaCell_Detector\lacuna-malaria-detection-dataset\test'
    label_file = r'C:\Users\geosaad\Desktop\MalariaCell_Detector\lacuna-malaria-detection-dataset\Train.csv'
    images, image_ids = load_malaria_cell_images(data_dir, label_file, True)
